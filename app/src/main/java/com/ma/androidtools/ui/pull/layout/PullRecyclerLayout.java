package com.ma.androidtools.ui.pull.layout;
 ...
 */
public class PullRecyclerLayout extends LinearLayout implements NestedScrollingParent {
    ...
    private RefreshEventListener onTouchUpListener = null;
    ...
    public void addRefreshListener(RefreshEventListener onTouchUpListener) {
